...
function updateFavList(){
    ...
    fav = JSON.parse(localStorage.getItem("favList"));
    if (fav  == null){
        fav = [];
    }
...
function isEligibletoAddToFav(id){
   let idInString =  localStorage.getItem('favList');// example : "1,2,3"
   let idS = JSON.parse(idInString); // convert to json i.e array : [1,2,3]
